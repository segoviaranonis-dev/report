/**
 * Caso filtro desde COD.GRUPO — canon 2.2.1.56
 * CHI (09) · 654 Normal/Promo/Liq/Comun · 638 Actual/Anterior/Promo/Liq
 */
...
/** Todos los ids de caso-filtro que aplican a la fila (multi OK · OR en UI). */
