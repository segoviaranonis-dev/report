...
/**
 * API: Árbol Ente → Estilo → Marca → SKU
 */
export async function GET(request: Request) {
  ...
  try {
    ...
    const arbol = construirArbolAlternativo(leaves, "ente-estilo-marca");
    ...
    const msg = e instanceof Error ? e.message : "Error árbol retail (local-estilo-marca)";
