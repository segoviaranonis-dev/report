-- MIG-140 — Exponer color.tono_canon en vistas catálogo RIMEC Web (tarjetas tono)
-- Base: MIG-138 · Doc: CHUSAR_PILAR_COLOR_TONO_CANON.md · CHUSAR_BUSQUEDA_COLOR_CANALES.md
...
COMMENT ON VIEW public.v_stock_rimec IS
  'Catálogo RIMEC Web CP/PREVENTA · TRÁNSITO_PP · color_tono_canon · MIG-140';
...
SELECT
  ...
  c.tono_canon AS color_tono_canon,
...
COMMENT ON VIEW public.v_stock_pe_rimec IS
  'Pronta entrega RIMEC · color_tono_canon · MIG-140';
