-- MIG-164 · Fix es_liquidacion — am_es_liquidacion DEFAULT false bloqueaba fallback SDRM
...
COMMENT ON VIEW public.v_stock_pe_rimec IS
  'Pronta entrega RIMEC · PPD Alejandro Magno · MIG-163/164 AM comercial + pilares FK';
