-- MIG-142 — v_stock_pe_rimec desde pedido_proveedor_detalle (Alejandro Magno · MIG-140)
-- Vista separada para catálogo PE local — NO UNION en v_stock_rimec (CP).
-- Discriminadores: entidad_comercial=STOCK · quincena=Pronta entrega · deposito_codigo · categoria_id=1
...
COMMENT ON VIEW public.v_stock_pe_rimec IS
  'Pronta entrega RIMEC · PPD Alejandro Magno MIG-140/142 · catálogo local separado de CP';
