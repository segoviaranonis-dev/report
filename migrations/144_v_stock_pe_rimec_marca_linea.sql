-- MIG-144 — v_stock_pe_rimec: descp_marca desde línea cuando ppd.id_marca es NULL
-- Evita tarjetas/filtros con marca_id real pero etiqueta "RIMEC".
...
COMMENT ON VIEW public.v_stock_pe_rimec IS
  'Pronta entrega RIMEC · PPD Alejandro Magno MIG-140/142/143/144 · joins indexables + marca desde línea';
