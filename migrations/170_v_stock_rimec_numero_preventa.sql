-- MIG-170 — v_stock_rimec: numero_preventa Carlos (pp.nro_pedido_externo) · tarjeta + filtro llegada
...
COMMENT ON VIEW public.v_stock_rimec IS
  'Catálogo RIMEC Web CP · MIG-170 numero_preventa Carlos + grada/LPN 638';
