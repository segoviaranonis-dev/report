-- MIG-181 — rimec_catalogo_meta CP: respetar p_ramo_tipo (iceberg sidebar CALZADO)
-- Síntoma: ?ramo_tipo=CALZADO mostraba PIJAMA FEM · LEGGING · KYLY en estilos CP.
-- Causa: rama CP del RPC (MIG-157) no filtraba ramo; PE sí (MIG-152).
-- Vista v_stock_rimec ya tiene ramo_tipo desde MIG-168 (638=CONFECCIONES · 654=CALZADO).
...
COMMENT ON FUNCTION public.rimec_catalogo_meta IS
  'Meta sidebar catálogo · MIG-181 CP respeta p_ramo_tipo (MIG-168 vista)';
