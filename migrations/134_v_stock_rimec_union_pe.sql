-- MIG-134 — v_stock_rimec UNION pronta entrega (estrategia Hiedra Venenosa)
-- TRÁNSITO_PP (MIG-109) + stock_pronta_entrega_rimec como PRONTA_ENTREGA
-- Doc: .claude/2_modulos/2.3_report/deposito_rimec/ESTRATEGIA_HIEDRA_VENENOSA_PE.md
...
COMMENT ON VIEW public.v_stock_rimec IS
  'Catálogo RIMEC Web · TRÁNSITO_PP (PP) UNION PRONTA_ENTREGA (stock_pronta_entrega_rimec). Estrategia Hiedra Venenosa MIG-134.';
