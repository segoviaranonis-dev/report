-- MIG-151 — CAT-LAT-T1: color_tono_canon + genero en vistas catálogo (CP + PE)
-- Base PE: MIG-150 · CP: MIG-138 · elimina N+1 enrichCatalogoRows en app

-- ── CP: columnas nuevas al final ─────────────────────────────────────────────
...
COMMENT ON VIEW public.v_stock_rimec IS
  'Catálogo RIMEC Web CP · TRÁNSITO_PP · MIG-151 tono+genero';

-- ── PE: recrear desde MIG-150 + tono + genero ───────────────────────────────
...
COMMENT ON VIEW public.v_stock_pe_rimec IS
  'Pronta entrega RIMEC · PPD · MIG-151 grada+tono+genero';
